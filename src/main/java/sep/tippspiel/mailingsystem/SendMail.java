...
public class SendMail {
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        GoogleClientSecrets clientSecrets =
                GoogleClientSecrets.load(jsonFactory, new InputStreamReader(SendMail.class.getResourceAsStream("/credentials.json")));
        ...
        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("users");
    }
